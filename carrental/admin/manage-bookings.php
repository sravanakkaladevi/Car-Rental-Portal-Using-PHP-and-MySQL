...
$msg="Return Successfully Accepted";
}
...
<a href="manage-bookings.php?reid=<?php echo htmlentities($result->id);?>" onclick="return confirm('Do you want to accept this return request?')"> Accept Return</a>
<?php } else { ?>
-
<?php } ?>
</td>
