...
if(isset($_GET['requestreturn']))
{
$bookingid=intval($_GET['requestreturn']);
$useremail=$_SESSION['login'];
$status=3;
$sql = "UPDATE tblbooking SET Status=:status WHERE id=:bookingid AND userEmail=:useremail AND Status=1";
...
{
$error="Return request could not be sent";
}
}
?><!DOCTYPE HTML>
<html lang="en">
...
<li>
    <h4 style="color:red">Booking No #<?php echo htmlentities($result->BookingNumber);?></h4>
                ...
                <div class="vehicle_status"> <a href="#" class="btn outline btn-xs active-btn">Confirmed</a>
                           <div style="margin-top:10px;"><a href="my-booking.php?requestreturn=<?php echo htmlentities($result->bookingid);?>" class="btn btn-xs" onclick="return confirm('Do you want to request a return for this booking?');">Request Return</a></div>
 ...
 <div class="vehicle_status"> <a href="#" class="btn outline btn-xs">Return Requested</a>
            <div class="clearfix"></div>
        </div>
